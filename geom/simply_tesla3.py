...
# основной канал
Box_1 = geompy.MakeBoxDXDYDZ(L, w * i2, w)
...
cut_in = geompy.MakeCutList(
    geompy.MakeRotation(
        geompy.MakeTranslation(
            geompy.MakeFuseList(
            [
                geompy.MakeBoxDXDYDZ(box_L2, w * i2, box_h),
                geompy.MakeTranslation(geompy.MakeCylinder(O, OY, r2, w * i2), r2, 0, box_h)
            ]
            ),
        rot * L  + (r1 - r2),
        0,
    ...
    geompy.MakeCutList(
        geompy.MakeRotation(
            geompy.TranslateDXDYDZ(
                geompy.MakeFuseList(
                    [
                        geompy.MakeBoxDXDYDZ(box_L1, w * i2, box_h),
                        geompy.TranslateDXDYDZ(geompy.MakeCylinder(O, OY, r1, w * i2), r1, 0, box_h)
                    ]
                ),
                rot * L ,
                0,
...
wall_b = geompy.MakePlane(
    geompy.MakeVertex(L * 0.5, w * i2, w * 0.5),
    OY,
    2000 + L)
