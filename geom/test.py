...
geomObj_41 = geompy.MakeVectorDXDYDZ(1, 0, 0)
geomObj_42 = geompy.MakeVertex(-10500, 0, 0)
[ent] = geompy.GetShapesOnPlaneWithLocation(tesla_valve, geompy.ShapeType["FACE"], geomObj_41, geomObj_42, GEOM.ST_ON)
geomObj_43 = geompy.MakeVectorDXDYDZ(1, 0, 0)
geomObj_44 = geompy.MakeVertex(25500.00000000001, 0, 0)
[out] = geompy.GetShapesOnPlaneWithLocation(tesla_valve, geompy.ShapeType["FACE"], geomObj_43, geomObj_44, GEOM.ST_ON)
[wall_b, wall_f, ent, out] = geompy.GetExistingSubObjects(tesla_valve, False)
geomObj_45 = geompy.MakeVectorDXDYDZ(1, 0, 0)
geomObj_46 = geompy.MakeVertex(-10500, 0, 0)
[geomObj_47] = geompy.GetShapesOnPlaneWithLocation(ent, geompy.ShapeType["FACE"], geomObj_45, geomObj_46, GEOM.ST_ON)
geomObj_48 = geompy.MakeVectorDXDYDZ(1, 0, 0)
geomObj_49 = geompy.MakeVertex(25500.00000000001, 0, 0)
[geomObj_50] = geompy.GetShapesOnPlaneWithLocation(out, geompy.ShapeType["FACE"], geomObj_48, geomObj_49, GEOM.ST_ON)
geomObj_51 = geompy.MakeVectorDXDYDZ(0, 0, 1)
geomObj_52 = geompy.MakeVertex(0, 0, 250)
[geomObj_53] = geompy.GetShapesOnPlaneWithLocation(wall_f, geompy.ShapeType["FACE"], geomObj_51, geomObj_52, GEOM.ST_ON)
geomObj_54 = geompy.MakeVertex(0, 0, -250)
geomObj_55 = geompy.MakeVectorDXDYDZ(0, 0, 1)
geomObj_56 = geompy.MakeCylinder(geomObj_54, geomObj_55, 1000, 1000)
geomObj_57 = geompy.MakeVertex(-5500.000000000001, 0, -250)
geomObj_58 = geompy.MakeVectorDXDYDZ(0, 0, 1)
geomObj_59 = geompy.MakeCylinder(geomObj_57, geomObj_58, 1000, 1000)
simply_box = geompy.MakeFuseList([geomObj_56, geomObj_59], True, True)
geomObj_60 = geompy.MakeTranslation(simply_box, 0, 0, 0)
geomObj_61 = geompy.MakeTranslation(simply_box, 12000, 0, 0)
geomObj_62 = geompy.MakeTranslation(simply_box, 6000.000000000001, 0, 0)
geomObj_63 = geompy.MakeTranslation(simply_box, 18000, 0, 0)
simply_box_num = geompy.MakeFuseList([geomObj_60, geomObj_61, geomObj_62, geomObj_63], True, False)
Fillet_1 = geompy.MakeFillet(tesla_valve, 10, geompy.ShapeType["EDGE"], [87, 176, 185, 194, 205, 218, 227, 233])
...
NETGEN_3D_Parameters_1.SetMaxSize( 48 )
NETGEN_3D_Parameters_1.SetMinSize( 24 )
...
NETGEN_3D_Parameters_1.SetLocalSizeOnShape(simply_box_num, 26.4)
...
Viscous_Layers_1 = NETGEN_1D_2D_3D.ViscousLayers(7.2,2,1.1,[ 159, 186, 90 ],1,smeshBuilder.NODE_OFFSET)
...
[ wall_b_1, wall_f_1, ent_1, out_1 ] = Mesh_1.GetGroups()
try:
  Mesh_1.ExportUNV( r'/home/nikita/OpenFOAM/nikita-10/run/tesla_+turbulent/TeslaValve/Mesh_simple.unv', 0 )
  pass
except:
  print('ExportUNV() failed. Invalid file name?')
#hyp_110.SetLength( 3651.37 ) ### not created Object
...
NETGEN_2D_Parameters_1.SetMaxSize( 48 )
NETGEN_2D_Parameters_1.SetMinSize( 24 )
...
NETGEN_2D_Parameters_1.SetLocalSizeOnShape(simply_box_num, 26)
...
NETGEN_3D_Parameters_1_1.SetMaxSize( 48 )
NETGEN_3D_Parameters_1_1.SetMinSize( 24 )
NETGEN_3D_Parameters_1_1.SetOptimize( 1 )
NETGEN_3D_Parameters_1_1.SetFineness( 5 )
NETGEN_3D_Parameters_1_1.SetGrowthRate( 0.05 )
NETGEN_3D_Parameters_1_1.SetLocalSizeOnShape(simply_box_num, 26)
...
Viscous_Layers_3 = NETGEN_3D.ViscousLayers(8,2,1.1,[ 90, 159, 186 ],1,smeshBuilder.NODE_OFFSET,'Viscous Layers')
...
smesh.SetName(out_2, 'out')
smesh.SetName(wall_f_2, 'wall_f')
smesh.SetName(ent_2, 'ent')
smesh.SetName(wall_b_2, 'wall_b')
